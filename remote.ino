...
const int u1joystickY = 1; // define y dir for u1
const int u2joystickY = 3; // define y dir for u2
...
void loop() {
  ...
  check();
  data[0] = analogRead(u1joystickY);
  data[1] = analogRead(u2joystickY);
